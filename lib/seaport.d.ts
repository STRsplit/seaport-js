import { BigNumberish, PayableOverrides, providers, Wallet } from "ethers";
...
export declare class Seaport {
     ...
     */
    signOrder(orderParameters: OrderParameters, counter: number, accountAddress?: string, wallet?: Wallet): Promise<string>;
    /**
