...
var Seaport = /** @class */ (function () {
                ...
                switch (_k.label) {
                    ...
                    case 6:
                        ...
                        createOrderAction = {
                            ...
                            createOrder: function (wallet) { return __awaiter(_this, void 0, void 0, function () {
                                var signature;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, this.signOrder(orderParameters, resolvedCounter, offerer, wallet)];
                                        case 1:
                                            signature = _a.sent();
                                            return [2 /*return*/, {
     ...
     */
    Seaport.prototype.signOrder = function (orderParameters, counter, accountAddress, wallet) {
        return __awaiter(this, void 0, void 0, function () {
            var signer, domainData, orderComponents, signature;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        signer = wallet || this.provider.getSigner(accountAddress);
